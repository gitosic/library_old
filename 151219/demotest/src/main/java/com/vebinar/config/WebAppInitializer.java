...
//                                  https://youtu.be/DclLJt8zDWk?t=1716
...
public class WebAppInitializer /*implements WebApplicationInitializer*/ {
    ...
    public void onStartup(javax.servlet.ServletContext servletContext) throws ServletException {
        ...
        ServletRegistration.Dynamic dispatcher = servletContext.addServlet("dispatcher", new DispatcherServlet(context));//создадим диспачер сервлет
